...
public class AuditController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AuditResponseDTO> getAuditById(@PathVariable("id") @Positive(message = "ID must be greater than 0") Long auditId) {
    ...
    public ResponseEntity<List<AuditResponseDTO>> getAuditsByOfficerId(@PathVariable @Positive(message = "ID must be greater than 0") Long officerId) {
